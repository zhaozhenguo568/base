...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', '18368053@qq.com', '18518673223', 1, 1, '2017-07-10 12:00:00');
COMMIT;
...
CREATE TABLE `tb_code` (
  ...
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户ID',
  `mobile` varchar(255) NOT NULL COMMENT '好吗',
  `code` varchar(10) NOT NULL COMMENT '验证码',
  `start` bigint(20) NOT NULL DEFAULT '0' COMMENT '发送时间',
  `end` bigint(20) NOT NULL DEFAULT '0' COMMENT '过期时间',
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_code` VALUES (1, 1, '18518673223', '144119', 1511857357301, 1511864557301);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_token` VALUES (2, 'c2348be3-9bc0-49b1-8eeb-2544ba5fa25b', '2017-12-05 17:27:33', '2017-11-28 17:27:33');
INSERT INTO `tb_token` VALUES (3, '8271b99b-30c9-4988-8102-ac5084e07a1e', '2017-12-06 10:14:53', '2017-11-29 10:14:53');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_user` VALUES (3, 'lizheng', '18518673223', '123456', '2017-11-29 10:04:35', 0);
COMMIT;
