...
public class MAILSend extends SenderWapper{
	...
	/**
	 * If the mode is mail,it's an instance of {@link cn.cisdom.base.sms.config.MailConfig}.
	 * If the mode is message,it's an instance of {@link cn.cisdom.base.sms.config.MessageConfig}
	 * */
